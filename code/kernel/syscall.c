...
syscall_func syscall_table[] = {
    ...
    sys_write,      // SYS_WRITE   = 1  (定义在 fs/fs.c)
    sys_malloc,     // SYS_MALLOC  = 2
    sys_free,       // SYS_FREE    = 3
    sys_open,       // SYS_OPEN    = 4  
    sys_close,      // SYS_CLOSE   = 5
    sys_read,       // SYS_READ    = 6
    sys_lseek,      // SYS_LSEEK   = 7
    sys_unlink,     // SYS_UNLINK  = 8
    sys_mkdir,      // SYS_MKDIR   = 9
    sys_opendir,    // SYS_OPENDIR = 10
    sys_closedir,   // SYS_CLOSEDIR= 11
    sys_readdir,    // SYS_READDIR = 12
    sys_rewinddir,  // SYS_REWINDDIR=13
    sys_rmdir,      // SYS_RMDIR   = 14
    sys_getcwd,     // SYS_GETCWD  = 15
    sys_chdir,      // SYS_CHDIR   = 16
    sys_stat,       // SYS_STAT    = 17
};
